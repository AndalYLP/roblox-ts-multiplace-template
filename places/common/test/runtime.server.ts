...
import type * as ConfigModule from "common/test/jest.config";
...
const [success, result] = runCLI(script, config, [
	...
	ServerScriptService.FindFirstChild("TS-common")!.FindFirstChild("__test__")!,
	ReplicatedStorage.FindFirstChild("TS-common")!.FindFirstChild("__test__")!,
]).await();
